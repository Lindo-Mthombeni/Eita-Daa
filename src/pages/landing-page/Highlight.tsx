...
export const Highlight: React.FC = () => {
  ...
  return (
    <section className="px-[min(5%,100px)] py-[clamp(4rem,8vw,10rem)] w-full max-w-[min(100%,1400px)] mx-auto">
      <h1 className="text-lg text-center font-head mb-[clamp(4rem,8vw,10rem)]">
      ...
      <div className="flex flex-col gap-40 lg:gap-[clamp(4rem,10vw,12rem)] mt-30 md:mt-[min(15vw,200px)]">
        {highlights.map(({ heading, text, buttonText, img }, index) => (
          <div
            key={index}
            className={`flex flex-col lg:items-stretch gap-[clamp(1.5rem,5vw,6rem)]
          ...
          >
            ...
            >
              ...
              <p className="text-sm text-gray-500 leading-relaxed grow">{text}</p>
              <Button
                effect={true}
                variant="secondary"
